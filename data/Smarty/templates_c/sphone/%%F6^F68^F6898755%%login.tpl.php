<?php /* Smarty version 2.6.27, created on 2016-01-29 17:08:42
         compiled from original/login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'original/login.tpl', 28, false),array('modifier', 'h', 'original/login.tpl', 55, false),array('modifier', 'sfGetErrorColor', 'original/login.tpl', 66, false),)), $this); ?>
...
";
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo ((is_array($_tmp=@HTTPS_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
<section id="slidewindow">
    ...
    <form name="login_original" id="login_original" method="post" action="javascript:;" onsubmit="return ajaxLogin();">
